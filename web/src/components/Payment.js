                    ...
                    {this.state.checked === 'card' &&
                        <Form.Row style={{ width: '75%' }}>
                            <Form.Group as={Col} controlId="cardNo">
                                ...
                                <Form.Control type="number" placeholder="card number 123456789" onChange={this.handleChange('cardNo')} value={this.state.cardNo} />
                            </Form.Group>
                            <Form.Group as={Col} controlId="cvc">
                                <Form.Label>CVC Number</Form.Label>
                                <Form.Control type="number" placeholder="CVC 2525" onChange={this.handleChange('cvc')} value={this.state.cvc} />
                            </Form.Group>
                            <Form.Group as={Col} controlId="exp">
                                <Form.Label>Exp date</Form.Label>
                                <Form.Control  placeholder="dd/mm 05/27" onChange={this.handleChange('exp')} value={this.state.exp} />
                            </Form.Group>
                        </Form.Row>
                    }
                    {this.state.checked === 'phone' &&
                        <Form.Row style={{ width: '75%' }}>
                            <Form.Group as={Col} controlId="phoneNo">
                                ...
                                <Form.Control type="number" placeholder="Phone number" onChange={this.handleChange('phoneNo')} value={this.state.phoneNo} />
                            </Form.Group>
                            <Form.Group as={Col} controlId="pin">
                                <Form.Label>PIN</Form.Label>
                                <Form.Control type="number" placeholder="PIN" onChange={this.handleChange('pin')} value={this.state.pin} />
                            </Form.Group>
                        </Form.Row>
                    }
                    <Form.Row style={{ width: '75%' }}>
