...
class Home extends Component {
    ...
    componentDidMount() {
        ...
        routes()
            .then(res => {
                ...
                this.setState({ fromOptions: options,toOptions: options })
            })
            .catch(err => {
                console.log(err)
            })
    ...
    handleChange = type => selectedOption => {
               //console.log("this one:",selectedOption);
                ...
                <Row style={{ alignItems: 'center', justifyContent: 'center' }}>
                    ...
                    <Form.Row style={{ width: '75%' }}>
                        <Form.Group as={Col} controlId="from">
                            ...
                            <Select options={this.state.fromOptions.filter(option =>{ return option.value !== this.state.to.value})} onChange= {this.handleChange("from")}   />
                        </Form.Group>
                        <Form.Group as={Col} controlId="to">
                            <Form.Label>To</Form.Label>
                            <Select options={this.state.toOptions.filter(option =>{ return option.value !== this.state.from.value})} onChange={this.handleChange("to")}  />
                        </Form.Group>
                    </Form.Row>
                    <Form.Row style={{ width: '75%' }}>
                        <Form.Group as={Col} controlId="from">
                    ...
                    <Form.Row style={{ width: '75%' }}>
                        ...
                        <Form.Group as={Col} controlId="formGridEmail">
                            ...
                            <Form.Control type="number" placeholder="qty" onChange={this.handleQtyChange()} />
                        </Form.Group>
                    </Form.Row>
