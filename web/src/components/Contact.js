...
class Contact extends Component {
    ...
    handleSubmit = event => {
     ...
     //  alert("sending request..");
        contact(this.state)
            .then(res => {
                toast.success("Your message has been sent to Railway office.\n thay will contact soon")
                        ...
                        <Form onSubmit={e => this.handleSubmit(e)}>
                            ...
                            <Form.Row>
                                <Form.Group as={Col} controlId="formGridPhone">
                                    ...
                                    <Form.Control type="username" type="number" placeholder="Enter Phone Number" onChange={this.handleChange('phone')} value={this.state.phone} />
                                </Form.Group>
                    ...
                    <Row style={{ alignItems: 'center', justifyContent: 'center', margin: 30 }}>
                        <Col>
                            <div id="page">
                                ...
                                <p><strong>Telephones : </strong>+91 11 2 421281 <br /><strong>Fax Nos : </strong>+91 11 2 446490<br /><strong>Email : </strong>
                                    <a href="#">demo@railway.gov.lk</a>
                                    <span style={{ display: 'none' }}>This e-mail address is being protected from spambots. You need JavaScript enabled to view it
                                        </span>
                                </p>
                                <p><strong>Railway Head Office Exchange Number</strong> : +91 11 2 421281</p>
                                <p><strong>Fort Railway Station Inquiries</strong> : +91 11 2 434215</p>
                                <p><strong>Deputy Operating Superintendent</strong> : +91 11 2 687099</p>
                                <p className="MsoNormal"><strong>Assistant Transportation Superintendent (Operation)</strong> : +91 11 2 692286</p>
                            </div>
                        </Col>
                    </Row>
                </Col>
